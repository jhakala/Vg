...
void InterpolateSignal(TString postfix) {
    ...
    if (postfix == "antibtag") {
        ...
        funcEff = new TF1("effFunc","[0]*TMath::ATan((x-[1])/[2])",650,4000);//W=0
        funcEff->SetParameters(0.09554, 641.6, 204.5); //W=0
        ...
        funcEff = new TF1("effFunc","[0]*TMath::ATan((x-650)/[1])*TMath::Power((x-[2])/[3], [4])",650,4000);
        funcEff->SetParameters(0.373325, 1323.2, 127.061, 553.036, -1.42761); //W=0
